...
// import 'package:unsplash/screens/favorite_page.dart';
// import 'package:unsplash/screens/home_page.dart';
...
import 'package:flutter_downloader/flutter_downloader.dart';
import 'package:unsplash/screens/main_page.dart';
import 'package:unsplash/simple_bloc_observer.dart';
import 'business_logic/Bloc/photos_bloc.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        body: BlocProvider(
          create: (_) => PhotoBloc(getImages: getImages)..add(PhotoFetched()),
